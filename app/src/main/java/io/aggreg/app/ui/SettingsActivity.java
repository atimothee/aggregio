...
//        addPreferencesFromResource(R.xml.pref_notification);
        ...
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_memory_usage);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_memory_usage);
...
//            // guidelines.
//            bindPreferenceSummaryToValue(findPreference(getResources().getString(R.string.pref_key_article_text_size)));
//        }
//    }
...
//    }
    ...
    public static class DataSyncPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getResources().getString(R.string.pref_key_refresh_interval)));
        }
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class MemoryUsagePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_memory_usage);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getResources().getString(R.string.pref_key_delete_stale_articles)));
        }
    }
